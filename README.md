For this project, I created a small table library to manage interactions with and building the table.

There is a little documentation for the table library here: https://github.com/codyogden/table-library
